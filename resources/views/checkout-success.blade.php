    ...
    <body class="min-h-screen bg-background font-sans text-foreground antialiased">
        <main class="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 py-16">
            ...
            <section class="checkout-panel relative z-10 mx-auto w-full max-w-3xl rounded-[2.2rem] border p-8 text-center shadow-[var(--shadow-elegant)] sm:p-12">
                ...
                <p class="mt-6 text-sm font-medium uppercase tracking-[0.28em] text-primary">Enrollment Confirmed</p>
                ...
                <p class="mx-auto mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
                    Your slot for <span class="font-semibold text-foreground">Build Real Full Stack Web Apps using AI and Codex</span> is now secured. You can continue the onboarding flow or go back to the landing page.
                </p>
                ...
                <div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                    <a href="{{ url('/') }}" class="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-primary px-8 py-4 text-sm font-semibold text-primary-foreground transition-all hover:scale-[1.02]" style="box-shadow: var(--shadow-elegant)">
                        <span class="relative z-10">Back to Landing Page</span>
                    </a>
                    <a href="{{ route('checkout') }}" class="inline-flex items-center justify-center rounded-full border border-border px-6 py-4 text-sm font-medium text-foreground/90 transition hover:bg-card/70">
                        Open Checkout Again
                    </a>
                </div>
            </section>
