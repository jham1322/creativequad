...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="dark">
    <head>
        ...
        @include('partials.meta-head', [
            'title' => 'Create New Password | Creative Quad Vibe Coding Course',
            'description' => 'Create a new password for your Creative Quad Vibe Coding Course account.',
            ...
            <section class="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 py-16">
                <div class="mx-auto w-full max-w-2xl">
                    <section class="checkout-panel rounded-[2rem] border p-6 sm:p-8">
                        <p class="text-sm font-medium uppercase tracking-[0.24em] text-primary">Create New Password</p>
