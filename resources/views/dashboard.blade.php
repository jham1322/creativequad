...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="dark">
    ...
    <body class="min-h-screen bg-background font-sans text-foreground antialiased">
        <main class="relative min-h-screen overflow-hidden bg-background">
            ...
            <section class="editorial-section relative mx-auto max-w-[1200px] px-6 pb-14 md:pb-20" id="projects-preview">
                <div class="build-showcase-stage relative overflow-hidden rounded-[2rem] border border-border px-6 py-10 shadow-[var(--shadow-elegant)] sm:px-8 lg:px-10 lg:py-12">
                    <div class="pointer-events-none absolute inset-0 build-showcase-glow" aria-hidden="true"></div>
                    <div class="pointer-events-none absolute inset-x-[12%] top-0 h-20 build-showcase-rim" aria-hidden="true"></div>

                    <div class="relative grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.35fr)] lg:items-end">
                        <div class="max-w-xl">
                            <p class="reveal reveal-delay-1 inline-flex items-center rounded-full border border-border px-4 py-2 text-sm font-medium uppercase tracking-[0.28em] text-primary">
                                What You'll Build
                            </p>
                            <h2 class="display-title reveal reveal-delay-2 mt-5 text-4xl font-semibold leading-tight tracking-tight text-foreground md:text-5xl">
                                Real client-style projects,
                                <span class="text-gradient">not just basic demos.</span>
                            </h2>
                            <p class="reveal reveal-delay-3 mt-5 max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
                                Inside the course, you will build polished storefronts, checkout flows, analytics dashboards, member areas, and full admin systems that look premium enough to present to real businesses.
                            </p>

                            <div class="reveal reveal-delay-4 mt-8 grid gap-3 sm:grid-cols-2">
                                <div class="build-showcase-note rounded-2xl border border-border px-4 py-4">
                                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-primary/80">Live Stack</p>
                                    <p class="mt-2 text-sm leading-6 text-foreground">Landing pages, storefronts, cart flows, checkout, member dashboards, and admin reporting.</p>
                                </div>
                                <div class="build-showcase-note rounded-2xl border border-border px-4 py-4">
                                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-primary/80">Built Like Real Work</p>
                                    <p class="mt-2 text-sm leading-6 text-foreground">Designed to feel client-ready, visually sharp, and structured like modern premium products.</p>
                                </div>
                            </div>
                        </div>

                        <div class="build-showcase-grid relative">
                            <article class="build-showcase-card build-showcase-card-feature reveal reveal-delay-1">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-8.png') }}" alt="Premium storefront landing page example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Featured Build</p>
                                    <h3>Premium storefront landing pages</h3>
                                    <p>Bold hero sections, product storytelling, and conversion-first layouts that feel polished from the first scroll.</p>
                                </div>
                            </article>

                            <article class="build-showcase-card build-showcase-card-tall reveal reveal-delay-2">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-6.png') }}" alt="Collection page example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Catalog UX</p>
                                    <h3>Collection and product discovery</h3>
                                </div>
                            </article>

                            <article class="build-showcase-card reveal reveal-delay-3">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-1.png') }}" alt="Shopping cart interface example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Commerce Flow</p>
                                    <h3>Cart and order review</h3>
                                </div>
                            </article>

                            <article class="build-showcase-card reveal reveal-delay-4">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-2.png') }}" alt="Checkout experience example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Checkout</p>
                                    <h3>Payment-ready interfaces</h3>
                                </div>
                            </article>

                            <article class="build-showcase-card reveal reveal-delay-2">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-3.png') }}" alt="Order confirmation page example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Success States</p>
                                    <h3>Post-payment experiences</h3>
                                </div>
                            </article>

                            <article class="build-showcase-card build-showcase-card-wide reveal reveal-delay-3">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-4.png') }}" alt="Member dashboard example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Client Portals</p>
                                    <h3>Member dashboards and account areas</h3>
                                    <p>Structured dashboards with order history, profile blocks, account states, and premium UI systems.</p>
                                </div>
                            </article>

                            <article class="build-showcase-card reveal reveal-delay-4">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-5.png') }}" alt="Admin login page example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Admin Access</p>
                                    <h3>Branded admin login screens</h3>
                                </div>
                            </article>

                            <article class="build-showcase-card reveal reveal-delay-5">
                                <div class="build-showcase-media">
                                    <img src="{{ asset('images/showcase/project-7.png') }}" alt="Analytics and reporting dashboard example" loading="lazy">
                                </div>
                                <div class="build-showcase-copy">
                                    <p class="build-showcase-kicker">Analytics</p>
                                    <h3>System dashboards and reporting</h3>
                                </div>
                            </article>
                        </div>
                    </div>
